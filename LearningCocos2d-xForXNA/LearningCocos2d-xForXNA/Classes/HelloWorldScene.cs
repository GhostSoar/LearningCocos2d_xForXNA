...
{
    public class LearningCocos2d_xForXNAScene : CCLayer
    {
        /// <summary>
        ...
        public static CCScene scene()
        {
            ...
            CCLayer layer = LearningCocos2d_xForXNAScene.node();
        ...
        {
            LearningCocos2d_xForXNAScene ret = new LearningCocos2d_xForXNAScene();
            if (ret.init())
            {
                return ret;
            }
